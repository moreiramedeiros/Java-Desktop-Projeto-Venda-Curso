...
public class FuncionariosDAO {
    ...
    public Funcionarios consultaPorNome(String nome) {
        try {
            //1 passo - criar o comando sql, organizar e exacutar
    ...
    public void efetuaLogin(String email, String senha) {
        try {
            ...
            if (rs.next()) {
                ...
                //Caso o usuário seja tipo admin
                if (rs.getString("nivel_acesso").equals("Administrador")) {
                    JOptionPane.showMessageDialog(null, "Seja bem-vindo ao Sistema como administrador");
                    FrmMenu tela = new FrmMenu();
                    tela.usuarioLogado = rs.getString("nome");
                    tela.setVisible(true);
                } //Caso o usuário tenha acesso limitado
                else if (rs.getString("nivel_acesso").equals("Usuário")) {
                    JOptionPane.showMessageDialog(null, "Seja bem-vindo ao Sistema como usuário");
                    FrmMenu tela = new FrmMenu();
                    tela.usuarioLogado = rs.getString("nome");
